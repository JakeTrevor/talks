...
\begin{tikzpicture}
    ...
    \node [draw] [below left  of=ql] [yshift=-20] [xshift=-50] [align=center] (cl)   {\ccfNode{CL}{Loops conditioned\\ {on classical data}}};
    \node [draw] [below right of=ql] [yshift=-20] [xshift=50]  [align=center] (qc)   {\ccfNode{QC}{Conditions using\\ {measurement results}}};
    ...
    \draw [black, thick] (ql) -- (cl);
    \draw [black, thick] (ql) -- (qc);
